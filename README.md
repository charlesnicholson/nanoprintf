...
nanoprintf makes no memory allocations and uses less than 100 bytes of stack. It compiles to between *~780-2500 bytes of object code* on a Cortex-M0 architecture, depending on configuration.
