...
def _build(platform: str, flags: list[str]) -> str:
    ...
    cc_exe = {
        "cm0": "arm-none-eabi-gcc",
        "cm4": "arm-none-eabi-gcc",
        "avr": "avr-gcc",
        "host": "cc",
    }[platform]

    cc_cmd = [cc_exe, "-c", "-x", "c", "-Os", f"-I{_git_root()}", "-o", "npf.o"]
    cc_cmd += {
        "cm0": ["-mcpu=cortex-m0"],
    ...
    nm_exe = {
        "cm0": "arm-none-eabi-nm",
        "cm4": "arm-none-eabi-nm",
        "avr": "avr-nm",
        "host": "nm",
    }[platform]
